...
export default {
  ...
  methods: {
    ...
    getWeathers() {
      const weatherAPI = 'https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-D0047-061?Authorization=CWA-5C92018F-E05F-458F-B9DF-C520AC286E92&format=JSON&elementName=';
